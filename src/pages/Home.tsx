    ...
    return (
        <div className="w-full">
            <div className="grid md:grid-cols-1 lg:grid-cols-2 mx-10 mt-20">
                <div>
                <img 
      src="https://images.unsplash.com/photo-1555892727-55b51e5fceae?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1374&q=80"
      alt="new"
      />
                </div>
                    ...
                    <div className="flex flex-col ">
                        ...
                        <div className="flex items-center justify-between mt-5  ">
                            <div className="flex items-center">
                                <img src="https://images.unsplash.com/photo-1434030216411-0b793f4b4173?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" className="rounded-full h-8 w-8" alt="/" />
           ...
           <ArrowSmRightIcon className="w-5" /> 
                <Link to ="/article" className="py-3 px-9 border"  onClick = {()=>{dispatch(article());  }}><p className="flex ">More </p></Link>        
            </div> */}
