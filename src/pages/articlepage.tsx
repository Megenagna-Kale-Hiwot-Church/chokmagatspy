...
const ArticlePage = () => {
    ...
    const imageUrl = "https://images.unsplash.com/photo-1555892727-55b51e5fceae?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1374&q=80 "
       return (
